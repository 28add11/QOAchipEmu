# TT07-QOA-Decoder-Firmware
Firmware for my Tiny Tapeout project available [here](https://tinytapeout.com/runs/tt07/tt_um_28add11_QOAdecode)!
Actual firmware for Tiny Tapeout dev board will be available later, as will the desktop side of software.
